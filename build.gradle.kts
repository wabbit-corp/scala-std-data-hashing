...
mavenPublishing {
    coordinates("one.wabbit", "scala-std-data-hashing", "0.0.1")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("scala-std-data-hashing")
        description.set("scala-std-data-hashing")
        url.set("https://github.com/wabbit-corp/scala-std-data-hashing")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/scala-std-data-hashing")
            connection.set("scm:git:git://github.com/wabbit-corp/scala-std-data-hashing.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/scala-std-data-hashing.git")
        }
    }
}
